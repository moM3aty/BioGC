    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelaxationPackages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RelaxationPackages_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AudioGuid = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RelaxationPackageId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelaxationAudios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RelaxationAudios_RelaxationPackages_RelaxationPackageId",
                        column: x => x.RelaxationPackageId,
                        principalTable: "RelaxationPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RelaxationVideos_RelaxationPackages_RelaxationPackageId",
                        column: x => x.RelaxationPackageId,
                        principalTable: "RelaxationPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRelaxationPackages", x => new { x.ApplicationUserId, x.RelaxationPackageId });
                    table.ForeignKey(
                        name: "FK_UserRelaxationPackages_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRelaxationPackages_RelaxationPackages_RelaxationPackageId",
                        column: x => x.RelaxationPackageId,
                        principalTable: "RelaxationPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RelaxationSubscriptions_RelaxationPackages_RelaxationPackageId",
                        column: x => x.RelaxationPackageId,
                        principalTable: "RelaxationPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelaxationAudios_RelaxationPackageId",
                table: "RelaxationAudios",
                column: "RelaxationPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_RelaxationPackages_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelaxationSubscriptions_RelaxationPackageId",
                table: "RelaxationSubscriptions",
                column: "RelaxationPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_RelaxationVideos_RelaxationPackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRelaxationPackages_RelaxationPackageId",
                table: "UserRelaxationPackages",
                column: "RelaxationPackageId");
